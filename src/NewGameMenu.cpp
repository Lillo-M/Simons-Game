...
Menus::NewGameMenu::NewGameMenu(States::StateMachine* pSM, Managers::InputManager* pIM):
    ...
    pIM(pIM)
{
    PushButtom(new GraphicElements::Button(sf::Vector2f(WIDTH/2 - 90,-30), 30, "Alaska"));
    PushButtom(new GraphicElements::Button(sf::Vector2f(WIDTH/2 - 90,0), 30, "Vulcano"));
    PushButtom(new GraphicElements::Button(sf::Vector2f(WIDTH/2 - 90,30), 30, "Quit To MainMenu"));
